...
class Application:
    ...
    def output_page(self, S_greedy, zmax_greedy, S_bee, zmax_bee, greedy_time, bee_time):
        ...
        if S_bee == None and zmax_bee == None:
            ...
            self.z_max.grid(row=1, column=1, sticky=W)
            self.l3.grid(row=2, column=0, sticky=W)
            self.greedy_time.grid(row=2, column=1, sticky=W)
            self.end_button.grid(row=3, column=1, sticky=W)
            ...
            self.z_max.grid(row=1, column=1, sticky=W)
            self.l3.grid(row=2, column=0, sticky=W)
            self.bee_time.grid(row=2, column=1, stiky=W)
            self.end_button.grid(row=3, column=1, sticky=W)
        else:
            ...
            self.l2.grid(row=1, column=0, sticky=W)
            self.zmax_greedy.grid(row=1, column=1, sticky=W)
            self.l3.grid(row=2, column=0, sticky=W)
            self.S_bee.grid(row=2, column=1)
            self.l4.grid(row=3, column=0, sticky=W)
            self.zmax_bee.grid(row=3, column=1, sticky=W)
            self.l5.grid(row=4, column=0, sticky=W)
            self.greedy_time.grid(row=4, column=1, sticky=W)
            self.l6.grid(row=5, column=0, sticky=W)
            self.bee_time.grid(row=5, column=1, sticky=W)
            self.end_button.grid(row=6, column=1, sticky=W)
